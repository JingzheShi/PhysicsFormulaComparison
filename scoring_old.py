...
def parse_arguements():
    ...
    parser.add_argument('--problem_formulas_location', type=str, default=r'E:\aiphy\CPHOSS_Formula_Comparison\problemFormulas\question1_config.py')
    parser.add_argument('--students_answers_location', type=str, default=r'E:\aiphy\CPHOSS_Formula_Comparison\studentsAnswers\students_answers_for_question1.pth')
